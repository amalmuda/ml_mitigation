---
title: "A model to identify development aid agreements targetning climate change mitigation"
...
We build a model to identify development agreements supporting developing countries in reducing greenhouse gas emmisions. The model is built using supervised machine learning.
...
Let's create a model specification for the model(s) we want to try. We are specifying a random forest model.
