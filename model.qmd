...
We build a model to identify development agreements supporting developing countries in reducing greenhouse gas emissions. The model is built using supervised machine learning.
...
# library(vetiver)
# 
# v <- vetiver_model(final_wf, "A model to identify development aid agreements targeting climate change mitigation")
# 
# v
# 
# library(plumber)
